#!/usr/bin/env python3
"""
Process a single video URL with Phase 1 checks
"""
...
def process_video(video_url: str):
    ...
    try:
        ...
        # Extract recommendations with Claude (smart processing)
        ...
        logger.info("💾 Saving processing metrics...")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python process_single_video.py <youtube_url>")
        sys.exit(1)
